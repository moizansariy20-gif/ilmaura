            ...
            {resources.length > 0 ? (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {resources.map((res, index) => (
                    ...
                    className="group flex gap-4 p-5 bg-[#FCFBF8] dark:bg-slate-800/50 rounded-2xl border border-[#D4AF37]/20 hover:border-[#D4AF37]/50 hover:shadow-lg transition-all relative overflow-hidden animate-in slide-in-from-bottom-4 duration-500"
                    >
              ...
              <div className="text-center py-20 bg-[#FCFBF8] dark:bg-slate-800/50 rounded-2xl border border-[#D4AF37]/20 border-dashed">
