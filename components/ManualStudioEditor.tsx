...
const ManualStudioEditor: React.FC<ManualStudioEditorProps> = ({ image, onSave, onCancel }) => {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-slate-900/95 backdrop-blur-md p-4">
      <div className="bg-white dark:bg-[#1e293b] rounded-3xl shadow-2xl w-full max-w-4xl overflow-hidden flex flex-col md:flex-row h-[90vh] md:h-auto">
        
        {/* Preview Area */}
        <div className="flex-1 bg-slate-100 p-8 flex items-center justify-center relative overflow-hidden">
          <div className="relative shadow-2xl border-4 border-white rounded-lg overflow-hidden bg-white dark:bg-[#1e293b]">
        ...
        {/* Controls Area */}
        <div className="w-full md:w-80 bg-white dark:bg-[#1e293b] p-6 border-l border-slate-100 dark:border-[#334155] flex flex-col gap-6">
          <div>
          ...
          {/* Actions */}
          <div className="flex gap-3 pt-6 border-t border-slate-100 dark:border-[#334155]">
            <button 
              onClick={onCancel}
              className="flex-1 py-3 px-4 rounded-xl border border-slate-200 dark:border-[#1e293b] text-slate-600 dark:text-slate-300 font-semibold hover:bg-slate-50 dark:bg-[#0f172a] transition-colors flex items-center justify-center gap-2"
            >
              <X size={18} />
              Cancel
            </button>
