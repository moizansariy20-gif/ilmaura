...
const Loader: React.FC<{ message?: string }> = ({ message = "Loading..." }) => {
  return (
    <div className="h-screen w-full flex flex-col items-center justify-center bg-white dark:bg-slate-800 gap-4">
      <div className="relative">
        <div className="w-12 h-12 border-2 border-slate-200 dark:border-slate-700 rounded-full"></div>
