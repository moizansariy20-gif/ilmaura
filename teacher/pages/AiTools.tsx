...
import { PenTool, FileText, ClipboardList, HelpCircle, Save } from 'lucide-react';
...
const AiTools: React.FC<AiToolsProps> = ({ profile, classes, subjects }) => {
  ...
  const renderLessonPlanner = () => (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 animate-in fade-in duration-300">
      <div className="lg:col-span-1 space-y-6">
        <div className="bg-gradient-to-b from-white to-[#6B1D2F]/5 p-6 rounded-[2rem] border border-[#6B1D2F]/10 dark:border-slate-700 shadow-[0_8px_30px_rgba(107,29,47,0.04),inset_0_1px_0_rgba(255,255,255,0.8)] relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="space-y-5">
              <div className="space-y-1.5">
                ...
                <input type="text" placeholder="e.g., Photosynthesis" value={lessonTopic} onChange={e => setLessonTopic(e.target.value)} className="w-full p-4 bg-white dark:bg-slate-800 border border-[#6B1D2F]/10 dark:border-slate-700 rounded-2xl font-bold text-sm text-slate-700 dark:text-slate-200 shadow-[inset_0_2px_4px_rgba(0,0,0,0.02)] outline-none focus:ring-2 focus:ring-[#6B1D2F]/20 focus:border-[#6B1D2F]/40 transition-all placeholder:text-slate-300"/>
              </div>
              <div className="space-y-1.5">
                <label className="text-[10px] font-black text-[#6B1D2F] dark:text-white/60 uppercase tracking-widest ml-1">Grade</label>
                <input type="text" value={grade} onChange={e => setGrade(e.target.value)} className="w-full p-4 bg-white dark:bg-slate-800 border border-[#6B1D2F]/10 dark:border-slate-700 rounded-2xl font-bold text-sm text-slate-700 dark:text-slate-200 shadow-[inset_0_2px_4px_rgba(0,0,0,0.02)] outline-none focus:ring-2 focus:ring-[#6B1D2F]/20 focus:border-[#6B1D2F]/40 transition-all"/>
              </div>
              <div className="space-y-1.5">
                <label className="text-[10px] font-black text-[#6B1D2F] dark:text-white/60 uppercase tracking-widest ml-1">Subject</label>
                <input type="text" placeholder="e.g. Science" value={subject} onChange={e => setSubject(e.target.value)} className="w-full p-4 bg-white dark:bg-slate-800 border border-[#6B1D2F]/10 dark:border-slate-700 rounded-2xl font-bold text-sm text-slate-700 dark:text-slate-200 shadow-[inset_0_2px_4px_rgba(0,0,0,0.02)] outline-none focus:ring-2 focus:ring-[#6B1D2F]/20 focus:border-[#6B1D2F]/40 transition-all placeholder:text-slate-300"/>
              </div>
      ...
      <div className="lg:col-span-2 bg-gradient-to-b from-white to-[#6B1D2F]/5 p-6 rounded-[2rem] border border-[#6B1D2F]/10 dark:border-slate-700 shadow-[0_8px_30px_rgba(107,29,47,0.04),inset_0_1px_0_rgba(255,255,255,0.8)] relative overflow-hidden flex flex-col">
        ...
        <div className="relative z-10 flex-1 flex flex-col">
            ...
            <textarea 
                ...
                className="flex-1 w-full min-h-[400px] p-6 bg-white dark:bg-slate-800 border border-[#6B1D2F]/10 dark:border-slate-700 rounded-2xl font-medium text-sm text-slate-700 dark:text-slate-200 shadow-[inset_0_2px_4_rgba(0,0,0,0.02)] outline-none focus:ring-2 focus:ring-[#6B1D2F]/20 focus:border-[#6B1D2F]/40 transition-all placeholder:text-slate-300 resize-none custom-scrollbar"
              ...
              <div className="relative z-10">
                  ...
                  <div className="space-y-5">
                      <div className="space-y-1.5">
                          ...
                          <input type="text" placeholder="e.g. History Test" value={quizTopic} onChange={e => setQuizTopic(e.target.value)} className="w-full p-4 bg-white dark:bg-slate-800 border border-[#6B1D2F]/10 dark:border-slate-700 rounded-2xl font-bold text-sm text-slate-700 dark:text-slate-200 shadow-[inset_0_2px_4px_rgba(0,0,0,0.02)] outline-none focus:ring-2 focus:ring-[#6B1D2F]/20 focus:border-[#6B1D2F]/40 transition-all placeholder:text-slate-300"/>
                      </div>
      ...
      <div className="lg:col-span-2 bg-gradient-to-b from-white to-[#6B1D2F]/5 p-6 rounded-[2rem] border border-[#6B1D2F]/10 dark:border-slate-700 shadow-[0_8px_30px_rgba(107,29,47,0.04),inset_0_1px_0_rgba(255,255,255,0.8)] relative overflow-hidden flex flex-col">
            ...
            <div className="relative z-10 flex-1 flex flex-col">
                ...
                <textarea 
                    ...
                    className="flex-1 w-full min-h-[400px] p-6 bg-white dark:bg-slate-800 border border-[#6B1D2F]/10 dark:border-slate-700 rounded-2xl font-medium text-sm text-slate-700 dark:text-slate-200 shadow-[inset_0_2px_4px_rgba(0,0,0,0.02)] outline-none focus:ring-2 focus:ring-[#6B1D2F]/20 focus:border-[#6B1D2F]/40 transition-all placeholder:text-slate-300 resize-none custom-scrollbar"
  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center gap-3">
        <PenTool size={32} className="text-[#6B1D2F] dark:text-white"/>
        <div>
            <h1 className="text-3xl font-black text-slate-800 dark:text-slate-100 tracking-tight">Teaching Tools</h1>
            <p className="text-slate-500 dark:text-slate-400 text-sm font-bold mt-1">Manage lesson plans and quizzes.</p>
        </div>
      </div>

      <div className="flex gap-2 bg-white dark:bg-slate-800 p-2 rounded-2xl w-fit border border-[#6B1D2F]/10 dark:border-slate-700 shadow-[0_4px_15px_rgba(107,29,47,0.03)]">
        <button
          onClick={() => setActiveTool('lessonPlanner')}
          className={`px-6 py-3 text-xs font-black uppercase tracking-widest rounded-xl transition-all ${activeTool === 'lessonPlanner' ? 'bg-[#6B1D2F]/5 text-[#6B1D2F] dark:text-white shadow-[inset_0_1px_0_rgba(255,255,255,1)] border border-[#6B1D2F]/10 dark:border-slate-700' : 'text-slate-500 hover:bg-slate-50'}`}
        >
          Lesson Planner
        </button>
        <button
          onClick={() => setActiveTool('quizGenerator')}
          className={`px-6 py-3 text-xs font-black uppercase tracking-widest rounded-xl transition-all ${activeTool === 'quizGenerator' ? 'bg-[#6B1D2F]/5 text-[#6B1D2F] dark:text-white shadow-[inset_0_1px_0_rgba(255,255,255,1)] border border-[#6B1D2F]/10 dark:border-slate-700' : 'text-slate-500 hover:bg-slate-50'}`}
        >
          Quiz Creator
        </button>
      </div>
