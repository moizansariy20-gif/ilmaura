  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-1 bg-gradient-to-b from-white to-[#FCFBF8] p-6 rounded-[2rem] border border-[#E5E0D8] dark:border-[#1e293b] shadow-[0_8px_30px_rgba(107,29,47,0.04),inset_0_1px_0_rgba(255,255,255,0.8)] relative overflow-hidden">
           {/* Decorative elements */}
        ...
        <div className="lg:col-span-2 bg-gradient-to-b from-white to-[#FCFBF8] p-6 rounded-[2rem] border border-[#E5E0D8] dark:border-[#1e293b] shadow-[0_8px_30px_rgba(107,29,47,0.04),inset_0_1px_0_rgba(255,255,255,0.8)] relative overflow-hidden flex flex-col">
            {/* Decorative elements */}
            ...
            {selectedExam ? (
                <div className="flex-1 flex flex-col relative z-10">
                    <div className="flex items-center justify-between mb-6 pb-4 border-b border-[#E5E0D8] dark:border-[#1e293b]">
                        <div>
                        ...
                        <div className="px-4 py-2 bg-[#FCFBF8] dark:bg-[#020617] rounded-xl border border-[#D4AF37]/20 shadow-[inset_0_2px_4px_rgba(0,0,0,0.02)]">
                    ...
                    <div className="flex-1 space-y-3 overflow-y-auto pr-2 custom-scrollbar">
                        {studentsForSelectedExam.map((student, index) => (
                            <div key={student.id} className="flex items-center justify-between p-4 bg-white dark:bg-[#1e293b] border border-[#E5E0D8] dark:border-[#1e293b] rounded-2xl shadow-sm hover:shadow-md transition-all group">
                                <div className="flex items-center gap-4">
                                    <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-[#FCFBF8] to-[#E5E0D8] text-[#6B1D2F] dark:text-white flex items-center justify-center font-black text-xs shadow-[inset_0_1px_0_rgba(255,255,255,0.8)] border border-[#E5E0D8] dark:border-[#1e293b]/50">
                                        {index + 1}
                                    </div>
                                    <div>
                                ...
                                <div className="flex items-center gap-3 bg-[#FCFBF8] dark:bg-[#020617] p-1.5 rounded-xl border border-[#E5E0D8] dark:border-[#1e293b] shadow-[inset_0_2px_4px_rgba(0,0,0,0.02)]">
                                    <input type="number" max={selectedExam.totalMarks} placeholder="0" className="w-16 p-2 bg-white dark:bg-[#1e293b] border border-[#E5E0D8] dark:border-[#1e293b] rounded-lg text-sm text-center font-black text-[#6B1D2F] dark:text-white focus:border-[#D4AF37] outline-none shadow-sm transition-all" />
                        ...
                        {studentsForSelectedExam.length === 0 && (
                            <div className="text-center py-12 text-[#6B1D2F] dark:text-white/40 font-bold text-sm bg-[#FCFBF8] dark:bg-[#020617] rounded-2xl border border-dashed border-[#E5E0D8] dark:border-[#1e293b]">
                 ...
                 <div className="flex flex-col items-center justify-center h-full text-[#6B1D2F] dark:text-white/40 text-center p-10 relative z-10">
                    <div className="w-20 h-20 rounded-full bg-[#FCFBF8] dark:bg-[#020617] flex items-center justify-center mb-4 shadow-[inset_0_2px_10px_rgba(0,0,0,0.02)] border border-[#E5E0D8] dark:border-[#1e293b]">
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="bg-gradient-to-b from-white to-[#FCFBF8] w-full max-w-lg rounded-[2.5rem] p-8 relative z-10 border border-[#D4AF37]/20 shadow-[0_20px_60px_rgba(107,29,47,0.15),inset_0_1px_0_rgba(255,255,255,0.8)] animate-in zoom-in-95 duration-200 overflow-hidden">
            ...
            <div className="flex items-center justify-between mb-8 relative z-10">
                ...
                <button onClick={() => setShowModal(false)} className="w-8 h-8 flex items-center justify-center rounded-full bg-[#FCFBF8] dark:bg-[#020617] text-[#6B1D2F] dark:text-white/40 hover:bg-rose-50 hover:text-[#6B1D2F] dark:text-white transition-colors">
                    <X size={16} />
                </button>
            </div>
            ...
            <div className="space-y-5 relative z-10">
              ...
              <div className="grid grid-cols-2 gap-4">
                 <div className="space-y-1.5">
                    ...
                    <input type="date" className="w-full p-4 bg-white dark:bg-[#1e293b] border border-[#E5E0D8] dark:border-[#1e293b] rounded-2xl font-bold text-[#6B1D2F] dark:text-white shadow-[inset_0_2px_4px_rgba(0,0,0,0.02)] outline-none focus:border-[#D4AF37] transition-all" value={form.date} onChange={e => setForm({...form, date: e.target.value})} />
                 </div>
                 <div className="space-y-1.5">
                    <label className="text-[10px] font-black text-[#6B1D2F] dark:text-white/40 uppercase tracking-widest ml-1">Total Marks</label>
                    <input type="number" className="w-full p-4 bg-white dark:bg-[#1e293b] border border-[#E5E0D8] dark:border-[#1e293b] rounded-2xl font-bold text-[#6B1D2F] dark:text-white shadow-[inset_0_2px_4px_rgba(0,0,0,0.02)] outline-none focus:border-[#D4AF37] transition-all" value={form.totalMarks} onChange={e => setForm({...form, totalMarks: Number(e.target.value)})} />
                 </div>
              </div>
