        ...
        <div className="px-4 md:px-6 space-y-8">
          ...
          <div className="bg-white dark:bg-[#1e293b] rounded-3xl p-6 md:p-8 shadow-[0_15px_50px_-12px_rgba(107,29,47,0.1)] border border-[#D4AF37]/20 relative z-10 overflow-hidden">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-[#FCFBF8] dark:bg-[#020617] p-6 rounded-2xl border-2 border-[#D4AF37]/30 border-dashed shadow-[inset_0_4px_10px_rgba(107,29,47,0.02)] space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-4 animate-in slide-in-from-top-4 duration-300">
                    <div>
                      ...
                      <input 
                        ...
                        className="w-full p-3 bg-white dark:bg-[#1e293b] border border-[#D4AF37]/20 rounded-xl text-xs font-bold text-[#6B1D2F] dark:text-white outline-none focus:ring-2 focus:ring-[#6B1D2F]/10 shadow-sm"
                      />
                    </div>
                    <div>
              ...
              filteredAnnouncements.length > 0 ? (
                <div className="grid grid-cols-1 gap-6">
                  {filteredAnnouncements.map(a => (
                    <div key={a.id} className="bg-white dark:bg-[#1e293b] p-6 md:p-8 rounded-3xl shadow-[0_10px_40px_-10px_rgba(107,29,47,0.1)] border border-[#D4AF37]/20 transition-all hover:shadow-[0_15px_50px_-12px_rgba(212,175,55,0.2)] hover:border-[#D4AF37]/50 relative overflow-hidden group">
