    ...
    <div className="space-y-8 animate-in fade-in duration-500 pb-20">
      {showDeleteConfirm && (
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
            ...
            <div className="bg-white dark:bg-[#1e293b] w-full max-w-sm rounded-[2.5rem] p-8 relative z-10 text-center shadow-[0_20px_60px_rgba(0,0,0,0.2),inset_0_1px_0_rgba(255,255,255,0.8)] border border-slate-200 dark:border-[#1e293b]/50 animate-in zoom-in-95">
                ...
                <div className="mt-8 flex gap-3">
                    <button onClick={() => setShowDeleteConfirm(false)} className="flex-1 py-3.5 bg-slate-50 dark:bg-[#0f172a] text-slate-600 dark:text-slate-300 rounded-2xl font-bold text-sm shadow-[inset_0_1px_0_rgba(255,255,255,0.8),0_2px_4px_rgba(0,0,0,0.05)] border border-slate-200 dark:border-[#1e293b]/50 hover:bg-slate-100 active:scale-95 transition-all">Cancel</button>
      ...
      {/* Header */}
      <div className="relative bg-white dark:bg-[#1e293b] rounded-[2.5rem] p-8 shadow-[0_8px_30px_rgba(107,29,47,0.04),inset_0_1px_0_rgba(255,255,255,0.8)] border border-[#6B1D2F]/10 dark:border-[#1e293b] overflow-hidden">
       ...
       <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-white dark:bg-[#1e293b] p-6 rounded-[2rem] shadow-[0_8px_30px_rgba(107,29,47,0.04),inset_0_1px_0_rgba(255,255,255,0.8)] border border-[#6B1D2F]/10 dark:border-[#1e293b] relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <select value={selectedClassId} onChange={e => setSelectedClassId(e.target.value)} className="w-full mt-2 p-4 bg-slate-50 dark:bg-[#0f172a]/50 border border-slate-200 dark:border-[#1e293b]/60 rounded-2xl font-bold text-slate-700 dark:text-slate-200 shadow-[inset_0_2px_4px_rgba(0,0,0,0.02)] focus:outline-none focus:ring-2 focus:ring-[#6B1D2F]/20 focus:border-[#6B1D2F]/30 transition-all appearance-none cursor-pointer">
        ...
        <div className="relative z-10">
          ...
          <select value={selectedSubjectId} onChange={e => setSelectedSubjectId(e.target.value)} disabled={!selectedClassId || availableSubjects.length === 0} className="w-full mt-2 p-4 bg-slate-50 dark:bg-[#0f172a]/50 border border-slate-200 dark:border-[#1e293b]/60 rounded-2xl font-bold text-slate-700 dark:text-slate-200 shadow-[inset_0_2px_4px_rgba(0,0,0,0.02)] focus:outline-none focus:ring-2 focus:ring-[#6B1D2F]/20 focus:border-[#6B1D2F]/30 transition-all appearance-none disabled:bg-slate-100 disabled:text-slate-400 disabled:cursor-not-allowed cursor-pointer">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-8">
        <div className="xl:col-span-4 space-y-6">
            <div className="bg-white dark:bg-[#1e293b] p-8 rounded-[2.5rem] shadow-[0_8px_30px_rgba(107,29,47,0.04),inset_0_1px_0_rgba(255,255,255,0.8)] border border-[#6B1D2F]/10 dark:border-[#1e293b] relative overflow-hidden">
              ...
              <h3 className="font-black text-slate-800 dark:text-slate-100 text-xl mb-6 flex items-center gap-3 relative z-10">
                  <div className="w-10 h-10 bg-[#6B1D2F]/5 rounded-xl flex items-center justify-center border border-[#6B1D2F]/10 dark:border-[#1e293b] shadow-[inset_0_1px_0_rgba(255,255,255,0.8)]">
              ...
              <div className="space-y-6 relative z-10">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input name="startDate" type="date" value={formState.startDate} onChange={handleInputChange} className="w-full mt-2 p-3.5 bg-slate-50 dark:bg-[#0f172a]/50 border border-slate-200 dark:border-[#1e293b]/60 rounded-2xl font-bold text-sm text-slate-700 dark:text-slate-200 shadow-[inset_0_2px_4px_rgba(0,0,0,0.02)] focus:outline-none focus:ring-2 focus:ring-[#6B1D2F]/20 focus:border-[#6B1D2F]/30 transition-all"/>
                  </div>
                  <div>
                    <label className="text-[10px] font-bold uppercase tracking-wider text-[#6B1D2F] dark:text-white/60 ml-1">End Date</label>
                    <input name="endDate" type="date" value={formState.endDate} onChange={handleInputChange} className="w-full mt-2 p-3.5 bg-slate-50 dark:bg-[#0f172a]/50 border border-slate-200 dark:border-[#1e293b]/60 rounded-2xl font-bold text-sm text-slate-700 dark:text-slate-200 shadow-[inset_0_2px_4px_rgba(0,0,0,0.02)] focus:outline-none focus:ring-2 focus:ring-[#6B1D2F]/20 focus:border-[#6B1D2F]/30 transition-all"/>
                  </div>
                </div>
                <div>
                  <label className="text-[10px] font-bold uppercase tracking-wider text-[#6B1D2F] dark:text-white/60 ml-1">Total Chapters</label>
                  <input name="numChapters" type="number" value={formState.numChapters} onChange={handleInputChange} className="w-full mt-2 p-3.5 bg-slate-50 dark:bg-[#0f172a]/50 border border-slate-200 dark:border-[#1e293b]/60 rounded-2xl font-bold text-sm text-slate-700 dark:text-slate-200 shadow-[inset_0_2px_4px_rgba(0,0,0,0.02)] focus:outline-none focus:ring-2 focus:ring-[#6B1D2F]/20 focus:border-[#6B1D2F]/30 transition-all"/>
                </div>
                ...
                {error && <p className="text-xs text-[#6B1D2F] dark:text-white font-bold text-center bg-[#6B1D2F]/5 p-3 rounded-xl border border-[#6B1D2F]/10 dark:border-[#1e293b] shadow-[inset_0_1px_0_rgba(255,255,255,0.8)]">{error}</p>}
              </div>
            </div>
          </div>
          
          <div className="xl:col-span-8 bg-white dark:bg-[#1e293b] p-8 rounded-[2.5rem] shadow-[0_8px_30px_rgba(107,29,47,0.04),inset_0_1px_0_rgba(255,255,255,0.8)] border border-[#6B1D2F]/10 dark:border-[#1e293b] relative overflow-hidden min-h-[600px]">
            ...
            {academicPlan ? (
                <div className="space-y-8 relative z-10">
                    <div className="flex justify-between items-start bg-slate-50 dark:bg-[#0f172a]/50 p-6 rounded-3xl border border-slate-200 dark:border-[#1e293b]/50 shadow-[inset_0_1px_0_rgba(255,255,255,0.8)]">
                        <div className="text-left">
                            <h2 className="text-2xl font-black text-slate-800 dark:text-slate-100 tracking-tight">{academicPlan.courseTitle}</h2>
                            <p className="font-bold text-xs text-[#6B1D2F] dark:text-white/80 uppercase tracking-widest mt-2 bg-[#6B1D2F]/5 inline-block px-3 py-1 rounded-lg border border-[#6B1D2F]/10 dark:border-[#1e293b]">{academicPlan.sessionDuration}</p>
                        </div>
                        <div className="flex items-center gap-3">
                           {savedPlan && (
                               <button onClick={handleDeletePlan} disabled={isSaving} className="p-3.5 bg-white dark:bg-[#1e293b] text-[#6B1D2F] dark:text-white rounded-2xl shadow-[inset_0_1px_0_rgba(255,255,255,0.8),0_2px_5px_rgba(0,0,0,0.05)] border border-slate-200 dark:border-[#1e293b]/60 hover:bg-[#6B1D2F]/5 active:scale-95 transition-all">
                                   <Trash2 size={18}/>
                               </button>
                           )}
                    ...
                    <div className="space-y-8 max-h-[65vh] overflow-y-auto custom-scrollbar -mr-4 pr-4">
                        {academicPlan.terms.map((term, termIndex) => (
                            <div key={termIndex} className="relative">
                                <div className="sticky top-0 z-20 bg-white/80 dark:bg-[#1e293b]/80 backdrop-blur-md py-3 mb-4 border-b border-slate-100 dark:border-[#334155]">
                                ...
                                <div className="space-y-6">
                                    {term.weeks.map((week, weekIndex) => (
                                        <div key={`${termIndex}-${weekIndex}`} className="bg-slate-50 dark:bg-[#0f172a]/50 rounded-3xl border border-slate-200 dark:border-[#1e293b]/50 shadow-[inset_0_1px_0_rgba(255,255,255,0.8)] overflow-hidden">
                                            <div className="bg-white dark:bg-[#1e293b] px-6 py-4 border-b border-slate-100 dark:border-[#334155]">
                                                ...
                                                {week.days.map((day, dayIndex) => {
                                                    ...
                                                    return (
                                                        <li 
                                                            ...
                                                            className={`flex items-start gap-4 p-5 hover:bg-white dark:bg-[#1e293b] transition-colors duration-200 cursor-pointer ${isChecked ? 'bg-[#6B1D2F]/5' : ''}`}
                                                        >
                                                            <div className={`w-6 h-6 mt-0.5 rounded-lg flex items-center justify-center transition-all duration-300 flex-shrink-0 border shadow-sm ${isChecked ? 'bg-[#6B1D2F] border-[#4A1421] shadow-[#6B1D2F]/20' : 'bg-white dark:bg-[#1e293b] border-slate-300 shadow-slate-200/50'}`}>
                                                            ...
                                                            <div className={`flex-1 transition-all duration-300 ${isChecked ? 'opacity-50' : 'opacity-100'}`}>
                                                                ...
                                                                <div className={`flex flex-wrap gap-2 items-center mt-3 ${isChecked ? 'line-through' : ''}`}>
                                                                    ...
                                                                    )) : <span className="text-xs text-slate-400 font-medium italic bg-slate-100 px-3 py-1.5 rounded-xl border border-slate-200 dark:border-[#1e293b]/50">No scheduled activities</span>}
                                                                </div>
                                                            </div>
                                                        </li>
                                                    );
                ...
                <div className="text-center text-slate-400 py-20 h-full flex flex-col justify-center items-center relative z-10">
                    <div className="w-24 h-24 bg-slate-50 dark:bg-[#0f172a] rounded-full flex items-center justify-center mb-6 border border-slate-100 dark:border-[#334155] shadow-[inset_0_1px_0_rgba(255,255,255,0.8)]">
