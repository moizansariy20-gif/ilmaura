            ...
            <div className="grid grid-cols-1 gap-6">
              {filteredClasses.length > 0 ? (
                filteredClasses.slice(0, visibleCount).map(cls => {
                  ...
                  return (
                    <div key={cls.id} className={`bg-white dark:bg-[#1e293b] p-6 rounded-3xl border border-[#D4AF37]/20 shadow-[0_10px_40px_-10px_rgba(30,58,138,0.1)] flex flex-col gap-6 transition-all duration-300 relative overflow-hidden group`}>
                      ...
                      <div className="flex items-center justify-between relative z-10 pl-3">
                        <div className="flex items-center gap-5">
                          <div className="relative shrink-0">
                            <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br from-[#1e3a8a] to-[#172554] text-white flex items-center justify-center font-black text-2xl shrink-0 border-2 border-white dark:border-[#1e293b] shadow-lg`}>
                      ...
                      <div className="grid grid-cols-2 gap-4 pl-3 relative z-10">
                        <div className="bg-[#FCFBF8] dark:bg-[#020617]/50 p-3 rounded-2xl border border-[#E5E0D8] dark:border-[#1e293b]">
                      ...
                      <div className="pl-3 relative z-10">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {classTeachers.length > 0 ? classTeachers.map((t: any) => (
                            <div key={t.id} className="flex items-center gap-2 bg-[#FCFBF8] dark:bg-[#020617] p-2 rounded-xl border border-[#E5E0D8] dark:border-[#1e293b] shadow-sm">
                ...
                <div className="col-span-full text-center py-24 rounded-3xl bg-white dark:bg-[#1e293b] shadow-[0_10px_40px_-10px_rgba(30,58,138,0.05)] border-2 border-[#D4AF37]/30 border-dashed">
  ...
  return (
    <div className="font-sans text-slate-900 dark:text-white animate-in fade-in duration-300 pb-20 bg-slate-100 min-h-screen p-4 md:p-6">
        ...
        <div className="w-full max-w-[1920px] mx-auto bg-white dark:bg-[#1e293b] border-2 border-slate-300 shadow-sm flex flex-col min-h-[90vh]">
            ...
            <div className="bg-[#1e3a8a] text-white p-6 shadow-md flex flex-col md:flex-row md:items-center justify-between border-b-4 border-slate-900">
                <div>
                    ...
                    <div className="flex items-center gap-4 mt-2">
                         <span className="bg-white dark:bg-[#1e293b] text-[#1e3a8a] px-3 py-1 text-xs font-black uppercase tracking-wider border border-slate-900">Academic</span>
                ...
                <div className="flex gap-3 mt-4 md:mt-0">
                     <button 
                        ...
                        className="flex items-center gap-2 px-6 py-3 bg-white dark:bg-[#1e293b] text-[#1e3a8a] text-xs font-black uppercase hover:bg-slate-200 transition-colors border-2 border-white shadow-sm rounded-none"
                     >
            ...
            <div className="p-8 space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    {/* Metric 1 */}
                    <div className="bg-white dark:bg-[#1e293b] p-6 border-2 border-blue-900 shadow-sm flex flex-col justify-between h-36 relative">
                    ...
                    {/* Metric 2 */}
                    <div className="bg-white dark:bg-[#1e293b] p-6 border-2 border-indigo-700 shadow-sm flex flex-col justify-between h-36 relative">
                        <div className="flex justify-between items-start">
                    ...
                    {/* Metric 3 */}
                    <div className="bg-white dark:bg-[#1e293b] p-6 border-2 border-slate-700 shadow-sm flex flex-col justify-between h-36 relative">
                        <div className="flex justify-between items-start">
                    ...
                    {/* Metric 4 */}
                    <div className="bg-white dark:bg-[#1e293b] p-6 border-2 border-emerald-600 shadow-sm flex flex-col justify-between h-36 relative">
                         <div className="flex justify-between items-start">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    {filteredClasses.map((cls, idx) => {
                        ...
                        return (
                          <div key={cls.id} style={{ animationDelay: `${idx * 50}ms` }} className="bg-white dark:bg-[#1e293b] border-2 border-slate-200 dark:border-[#1e293b] shadow-sm hover:shadow-xl hover:border-[#1e3a8a] transition-all group relative animate-in slide-in-from-bottom-4 flex flex-col justify-between">
                             ...
                             <div className="p-6">
                                <div className="flex justify-between items-start mb-6">
                                    ...
                                    <div className="w-12 h-12 bg-slate-100 overflow-hidden border-2 border-slate-200 dark:border-[#1e293b] rounded-none group-hover:border-[#1e3a8a] transition-colors flex items-center justify-center">
                                         {displayPhoto ? (
                                             <img 
                                                src={displayPhoto} 
                                                alt={teacherName} 
                                ...
                                <div className="space-y-3">
                                    <div className="flex items-center justify-between p-3 bg-slate-50 dark:bg-[#0f172a] border border-slate-100 dark:border-[#334155] group-hover:border-blue-100 transition-colors">
                                        ...
                                        <div className="flex items-center gap-2">
                                            {cls.classTeacher?.photoURL && (
                                                <img src={cls.classTeacher.photoURL} className="w-5 h-5 rounded-full object-cover border border-slate-200 dark:border-[#1e293b]" alt="" />
                                            )}
                                            ...
                                            {cls.classMonitor ? (() => {
                                                ...
                                                return monitor ? (
                                                    <div className="flex items-center gap-1">
                                                        {monitor.photoURL ? (
                                                            <img src={monitor.photoURL} alt={monitor.name} className="w-4 h-4 rounded-full object-cover border border-slate-200 dark:border-[#1e293b]" />
                                                        ) : (
                                    ...
                                    <div className="relative">
                                        <div 
                                            ...
                                            className="flex items-center justify-between p-3 bg-slate-50 dark:bg-[#0f172a] border border-slate-100 dark:border-[#334155] hover:border-blue-200 transition-colors cursor-pointer"
                                        >
                                        ...
                                        {openTeacherDropdown === cls.id && cls.involvedTeachers && cls.involvedTeachers.length > 0 && (
                                            <div className="absolute bottom-full left-0 w-full mb-2 z-10">
                                                <div className="bg-white dark:bg-[#1e293b] border border-slate-200 dark:border-[#1e293b] shadow-xl rounded-md overflow-hidden max-h-48 overflow-y-auto">
                                                    {cls.involvedTeachers.map(teacherId => {
                                                        ...
                                                        return (
                                                            <div key={teacherId} className="flex items-center gap-3 p-2 border-b border-slate-50 last:border-0 hover:bg-slate-50 dark:bg-[#0f172a]">
                                                                {teacher.photoURL ? (
                                                                    <img src={teacher.photoURL} alt={teacher.name} className="w-6 h-6 rounded-full object-cover border border-slate-200 dark:border-[#1e293b]" />
                                                                ) : (
                             ...
                             <div className="flex border-t-2 border-slate-100 dark:border-[#334155]">
                                <button 
                                ...
                                <button 
                                    ...
                                    className="px-6 py-4 bg-white dark:bg-[#1e293b] text-rose-500 font-black text-[10px] uppercase tracking-widest hover:bg-rose-50 transition-colors"
                                >
                    ...
                    {filteredClasses.length === 0 && (
                        <div className="col-span-full py-24 text-center border-4 border-dashed border-slate-200 dark:border-[#1e293b] bg-slate-50 dark:bg-[#0f172a]">
        ...
        {confirmDeleteTarget && (
            ...
            <div className="bg-white dark:bg-[#1e293b] w-full max-w-sm rounded-none border-4 border-rose-600 p-0 relative z-10 shadow-2xl animate-in zoom-in-95">
                ...
                <div className="flex border-t-2 border-slate-100 dark:border-[#334155]">
                    <button onClick={() => setConfirmDeleteTarget(null)} className="flex-1 py-4 bg-slate-50 dark:bg-[#0f172a] text-slate-500 dark:text-slate-400 font-black text-xs uppercase tracking-widest hover:bg-slate-100 transition-colors">Cancel</button>
                    <button onClick={handleExecuteDelete} className="flex-1 py-4 bg-white dark:bg-[#1e293b] text-rose-600 font-black text-xs uppercase tracking-widest hover:bg-rose-50 transition-colors border-l-2 border-slate-100 dark:border-[#334155]">Yes, Delete</button>
                </div>
            </div>
            </div>
        )}
