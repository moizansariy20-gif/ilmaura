...
const MobileSkeleton = () => (
  <div className="md:hidden min-h-screen flex flex-col bg-[#FCFBF8] dark:bg-slate-900 transition-colors duration-300 overflow-y-auto no-scrollbar">
    <style>{`
...
const DesktopSkeleton = () => (
  <div className="hidden md:block p-6 space-y-8">
      ...
      <div className="grid grid-cols-4 gap-6">
        {[1, 2, 3, 4].map((i) => (
          <div key={i} className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700 h-32">
      ...
      <div className="grid grid-cols-3 gap-8">
        <div className="col-span-2 bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700 h-80">
...
const PrincipalSkeleton: React.FC = () => {
  return (
    <div className="min-h-screen bg-[#FCFBF8] dark:bg-slate-900 transition-colors duration-300">
      <style>{`
        @keyframes shimmer {
          100% { transform: translateX(100%); }
        }
